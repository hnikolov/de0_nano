...
from de0_nano_1.de0_nano_1 import de0_nano_1

class t_de0_nano_1(Testable):
    '''|
    ...
    def run_it(self, checkfiles=False):
        self.check_config("de0_nano_1")

        de0_nano_1_dut = de0_nano_1(IMPL=self.models)
        de0_nano_1_dut.Simulate(tb_config=self.tb_config, tst_data=self.tst_data, verbose=self.verbose)
        de0_nano_1_dut.clean()
